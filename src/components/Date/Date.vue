    ...
    <div>
        ...
        <div class="relative rounded-md shadow-sm" :class="label ? 'mt-1' : ''">
            <input
                ...
                :class="error ? 'pr-10 border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500' : 'pr-3 border-gray-300 text-gray-800 focus:ring-blue-400 focus:border-blue-400 placeholder-gray-400'">
